...
public class Params {
	...
	//STUFF ABOUT TEST BDD
	public final static String URLTEST = "jdbc:mysql://localhost:3306/paymybudy";
	public final static String USERTEST = "root";
	public final static String PASSWORDTEST = "rootroot";
